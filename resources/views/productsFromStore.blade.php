...
<head>
    ...
    <style>
        .centered-div {
            font-family: 'Forte Regular', cursive;
...
<body style="background-color: #FFFFFF">
    ...
    <div class="centered-div">
        ...
        PRODUCTS PAGE FROM<br>
    </div>

    <div class="centered-div" style="padding-top:10%">
        {{-- i want t change this so it uses "forte regular" font --}}
        {{ App\Models\Store::where('id', session('store_id'))->first()->name }}
    </div>
        ...
        @foreach (App\Models\Product::all() as $product)
            @if ($product->store_id == session('store_id'))
                <div class="grid-item">
                    ...
                    <p><strong>Store:</strong> {{ App\Models\Store::where('id', $product->store_id)->first()->name }}
                    </p>
                </div>
            @endif
        @endforeach
